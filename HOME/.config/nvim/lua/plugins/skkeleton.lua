...
return {
    {
        ...
        init = function()
            ...
            wk.add({
                { "<C-M-S-j>", "<Plug>(skkeleton-enable)", mode = { "i", "c" }, desc = "Skkeletonを有効にする" },
                { "<C-M-S-e>", "<Plug>(skkeleton-disable)", mode = { "i", "c" }, desc = "Skkeletonを無効にする" },
            })
        end,
        config = function()
            local dictionaries = {}
            local handle = io.popen(
                "ls ~/Library/Containers/net.mtgto.inputmethod.macSKK/Data/Documents/Dictionaries/SKK-JISYO.L")
            if handle then
            ...
            vim.api.nvim_create_autocmd("User", {
                ...
                callback = function()
                    vim.fn["skkeleton#config"]({
                        ...
                        userDictionary =
                        "~/Library/Containers/net.mtgto.inputmethod.macSKK/Data/Documents/Dictionaries/my_dictionary",
                    })
                end,
            })
