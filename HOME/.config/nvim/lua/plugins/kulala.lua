...
return {
  ...
  opts = {
    ...
    contenttypes = {
      ...
      ["application/graphql"] = {
        ft = "graphql",
        formatter = vim.fn.executable("prettier") == 1 and { "prettier", "--stdin-filepath", "graphql", "--parser", "graphql" },
        pathresolver = nil,
      },
      ["application/xml"] = {
        ft = "xml",
    ...
    -- Prefix for global keymaps (https://neovim.getkulala.net/docs/getting-started/default-keymaps)
