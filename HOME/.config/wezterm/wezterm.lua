...
tabline.setup({
	options = {
		...
		component_separators = {
			left = wezterm.nerdfonts.ple_backslash_separator_redundant,
			right = wezterm.nerdfonts.ple_backslash_separator_redundant,
		},
		tab_separators = {
			left = wezterm.nerdfonts.ple_pixelated_squares_small,
			right = wezterm.nerdfonts.ple_pixelated_squares_small_mirrored,
		},
	},
	sections = {
		tabline_a = { {
